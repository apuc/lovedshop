        ...
        <form action="" class="cart_form">
                ...
                <div class="cart_form__items">
                    <div class="cart_form__items-item">
                        ...
                        <div class="cart_item__prices">
                            <div class="cart_item__prices-price">{$model->vp->first()->price} &#8381;</div>
                            <div class="cart_item__prices-forone">1 шт - <span>{$model->vp->first()->price} &#8381;</span></div>
                        </div>
                        <div class="cart_item__count">
                            ...
                            <div class="card_item__available">Доступно: <span>26</span></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="cart_form__right">
                <div class="cart_total">
                    <p>Товары</p>
                    <div class="cart_total__price">{$model->vp->first()->price} &#8381;</div>
                    <p>Доставка</p>
                    <div class="cart_total__price">250 &#8381;</div>
                    <p>Итого</p>
                    <div class="cart_total__price">{$model->vp->first()->price + 250} &#8381;</div>
